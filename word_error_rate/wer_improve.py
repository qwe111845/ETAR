...
def wer(truth,  # type: Union[str, List[str], List[List[str]]]
        hypothesis,  # type: Union[str, List[str], List[List[str]]]
        standardize=False,
    ...
    n = len(truth)
    error_rate = float(distance) / float(n)
...
def _preprocess(text,  # type: Union[str, List[str], List[List[str]]]
...
def _preprocess_text(phrase,  # type: str
                     standardize=False,  # type: bool
                     words_to_remove=None  # type: List[str]
                     ):  # type: (...)-> List[str]
    """
...
def _standardise(phrase  # type: str
                 ):
    """
...
def _edit_distance(a,  # type: List[int]
                   b  # type: List[int]
                   ):  # type: (...)-> int
    """
